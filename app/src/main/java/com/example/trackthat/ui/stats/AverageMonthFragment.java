...
public class AverageMonthFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_average_month, container, false);
    }
            ...
            public void onLoaded(List<Habit> habits) {
                repository.getAllEntries(new HabitRepository.OnEntriesLoadedListener() {
                    ...
                    public void onLoaded(List<HabitEntry> entries) {
                        ...
                        // Map: habitId -> Map: yearMonth -> count
                        ...
                        // Durchschnitt berechnen (nur vergangene Monate, normalisiert auf currentDay)
                        ...
                        for (Habit habit : habits) {
                            ...
                            if (monthMap != null) {
                                ...
                                int totalPastMonths = 0;
                                float totalNormalized = 0;

                                for (Map.Entry<String, Integer> e : monthMap.entrySet()) {
                                    if (!e.getKey().equals(currentYearMonth)) {
                                        // Normalisierung: hochrechnen auf currentDay Tage
                                ...
                                if (totalPastMonths > 0) {
                                    avgCount = totalNormalized / totalPastMonths;
                                }
                            }
